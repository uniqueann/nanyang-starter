...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__CD5197E",
    appName: "uni-starter",
    appVersion: "1.01.230510",
    appVersionCode: "100",
...
let S;
S = _;
const k = m('{\n    "address": [\n        "127.0.0.1",\n        "172.16.18.51"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "E:/360Downloads/Software/hx/HBuilderX.3.6.15.20221228/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), I = m('[{"provider":"aliyun","spaceName":"uniq-app","spaceId":"mp-1314bf79-7302-487f-a70e-a5272fc68140","clientSecret":"lTREh1DViXFG7UTUJiTBvw==","endpoint":"https://api.next.bspapp.com"}]') || [];
let T = "";
try {
  T = "__UNI__CD5197E";
} catch (e2) {
  ...
  methods: {
    ...
    show() {
      ...
      if (this._hasCallback()) {
        const userCryptoManager = wx$1.getUserCryptoManager();
    ...
    _onmpclose(e2) {
      this._dispatchEvent(EventType.Close, e2.detail);
      if (e2.detail.adsdata) {
        const adv = e2.detail.adv;
        const adsdata = e2.detail.adsdata;
        const version2 = e2.detail.version;
        Es.callFunction({
          name: "uniAdCallback",
          data: {
            adv,
        ...
        delete e2.detail.adv;
        delete e2.detail.adsdata;
        delete e2.detail.version;
      }
    },
    _onmperror(e2) {
      this.loading = false;
      this.errorMessage = JSON.stringify(e2.detail);
      this._dispatchEvent(EventType.Error, e2.detail);
    },
